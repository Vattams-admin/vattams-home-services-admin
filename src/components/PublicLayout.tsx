...
import { Phone, MessageCircle, PlayCircle, Menu, X, Facebook, Instagram, Linkedin, Twitter, Send } from 'lucide-react'
...
export function PublicLayout() {
  ...
  const navLinks = [
    ...
    { to: '/blog', label: 'Blog' }, { to: '/reviews', label: 'Reviews' }, { to: '/contact', label: 'Contact' },
  ]
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <footer className="bg-gray-900 text-white">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 md:grid-cols-4">
          <div>
            <div className="mb-4 flex items-center gap-2"><Logo className="h-8 w-8" /><span className="text-xl font-bold">VATTAMS</span></div>
            <p className="mb-4 text-sm text-gray-400">Professional home services across Tamil Nadu.</p>
            <div className="flex gap-3">
              <a href={YOUTUBE_URL} target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white"><PlayCircle className="h-5 w-5" /></a>
              <a href="https://facebook.com/vattams" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white"><Facebook className="h-5 w-5" /></a>
              <a href="https://instagram.com/vattams" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white"><Instagram className="h-5 w-5" /></a>
              <a href="https://linkedin.com/company/vattams" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white"><Linkedin className="h-5 w-5" /></a>
              <a href="https://twitter.com/vattams" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white"><Twitter className="h-5 w-5" /></a>
              <a href={whatsappSupportLink('Hello VATTAMS')} target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white"><MessageCircle className="h-5 w-5" /></a>
              <a href="https://t.me/vattams" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white"><Send className="h-5 w-5" /></a>
            </div>
          </div>
          <div><h3 className="mb-3 text-sm font-semibold">Quick Links</h3><ul className="space-y-2 text-sm text-gray-400"><li><Link to="/services" className="hover:text-white">Services</Link></li><li><Link to="/pricing" className="hover:text-white">Pricing</Link></li><li><Link to="/cities" className="hover:text-white">Cities</Link></li><li><Link to="/about" className="hover:text-white">About Us</Link></li><li><Link to="/reviews" className="hover:text-white">Reviews</Link></li></ul></div>
